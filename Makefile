...
tests: ## test and lint
	python3 -m pytest --cov=tests --cov=playerstars_domain -W ignore::DeprecationWarning --cov-report term-missing:skip-covered
	@echo "Linting..."
	@flake8 playerstars_domain/ --max-complexity=5
